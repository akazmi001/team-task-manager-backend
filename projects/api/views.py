...
from users.permissions import IsAdmin, IsAdminOrOnlyPatch
...
class TaskViewSet(ModelViewSet):
    ...
    permission_classes = [IsAuthenticated, IsAdminOrOnlyPatch]
    ...
    def update(self, request, *args, **kwargs):
        if request.user.role == "member":
            MEMBER_FORBIDDEN_FIELDS = ["title", "description", "project", "assigned_to", "created_by", "due_date"]
            for field in MEMBER_FORBIDDEN_FIELDS:
